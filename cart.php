...
$name = "Sanidhya Mangal";
$address = "164 RNT Marg Chawwani Indore";
$phone  = '+91 980 690 8385';
?>
<html>
<head>
	...
	<div class="product-list">
		...
		<table>
			...
			<tr>
				...
				<td align="right"><?php printf("$ %10.2f",$qty1*$price1) ?> </td>
				<td>
					<table>
					<tr>
						<td>Remove</td>
			...
			<tr>
				...
				<td align="right"><?php printf("$ %10.2f",$price2*$qty2);?> </td>
				<td>
					<table>
					<tr>
						<td>Remove</td>
			...
			<tr>
				...
				<td align="right"><?php printf("$ %10.2f",$price3*$qty3) ?></td>
				<td>
					<table>
					<tr>
						<td>Remove</td>
